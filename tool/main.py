        ...
        try:
            ...
            if ('ink.js' not in target_dir_files):
                ...
                dial = wx.MessageDialog(
                    None, '无法导入 Inky Go\n' + target_dir + "不是 Inky 导出的 Web 项目目录", '错误', wx.OK)
                dial.ShowModal()
                return
            ...
            html_file_encoding = self.get_encoding(html_file)
            with open(html_file, 'r', encoding = html_file_encoding) as file:
            ...
            replace_index_html_encoding = self.get_encoding(replace_index_html)
            with open(replace_index_html, 'r', encoding = replace_index_html_encoding) as file:
            ...
            # 写入文件
            with open(replace_index_html, 'w', encoding = replace_index_html_encoding) as file:
